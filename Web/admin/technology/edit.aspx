<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="edit.aspx.cs" Inherits="HawaiiDBEDT.Web.Admin.TechnologyDetail" %>
            ...
            <div id="wideContentWrapper">
                <div class="wideContentWrapper">
                    ...
                    <p class="required">
                        <%= ConfirmationText %></p>
                    <p>
                        Select permit sets for the technology below. Click "Save" to submit your changes
                        and return to this current page. Click "Submit" to submit your changes and return
                        to the technology list page.
                    </p>

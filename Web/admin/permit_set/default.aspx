<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="HawaiiDBEDT.Web.Admin.PermitSetList" %>
		...
		<div id="contentWrapper">
			<div id="wideContentWrapper">
				<div class="wideContentWrapper">
					...
					<p>
						Use the filter below to narrow the list of permit sets. Sort the list by clicking on a column title. Click on the
						permit set name or the edit icon to view or edit permit set details.</p>
					<table>
						<tr>
							<td>
								Filter by Permit:
								<asp:DropDownList ID="rcbPermit" runat="server" Title="Filter By Permit"
									DataTextField="Name" DataValueField="ID" Width="350px" Skin="Custom" EnableEmbeddedSkins="false"
									 />
							</td>
							<td>
                    ...
                    <div class="commandRow">
						<a href="edit.aspx">
							<img src="/include/controls/radcontrols/grid/AddRecord.gif" alt="Add New Permit Set" /></a>
						<a href="edit.aspx">Add New Permit Set</a>
					</div>
					<cc1:TopPagerGridView ID="gridRecords" runat="server" GridLines="None" 
						AllowPaging="true" AllowSorting="true" OnPageIndexChanging="HandlePaging" OnSorting="HandleSorting"
						AutoGenerateColumns="false" PageSize="20" Skin="Custom" OnDataBound="HandleDataBound"
						EnableEmbeddedSkins="false" CssClass="dataGrid">
